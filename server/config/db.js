...
//     user: process.env.DB_USER,         // データベースユーザー名 (例: 'root')
//     password: process.env.DB_PASSWORD, // データベース接続に使用するパスワード (例: 'password123')
//     database: process.env.DB_NAME      // 使用するデータベース名 (例: 'user_database')
// });
